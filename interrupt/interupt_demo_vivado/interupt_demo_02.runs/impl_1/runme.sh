...
HD_PWD='E:/pynq/1.vivado_prj/interupt_demo_02/interupt_demo_02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_system_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_system_design_wrapper.tcl -notrace
