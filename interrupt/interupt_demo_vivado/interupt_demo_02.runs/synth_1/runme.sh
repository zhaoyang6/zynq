...
HD_PWD='E:/pynq/1.vivado_prj/interupt_demo_02/interupt_demo_02.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_system_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_system_design_wrapper.tcl
